 ...
 */
final class Version20251218073923 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, room_id INT DEFAULT NULL, created_by_client_id INT DEFAULT NULL, updated_by_client_id INT DEFAULT NULL, created_by_user_id INT DEFAULT NULL, updated_by_user_id INT DEFAULT NULL, starting_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ending_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', total_amount_cents INT NOT NULL, status VARCHAR(50) NOT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_E00CEDDE19EB6921 (client_id), INDEX IDX_E00CEDDE54177093 (room_id), INDEX IDX_E00CEDDE43EE6C4C (created_by_client_id), INDEX IDX_E00CEDDEBCEDEAAC (updated_by_client_id), INDEX IDX_E00CEDDE7D182D95 (created_by_user_id), INDEX IDX_E00CEDDE2793CC5E (updated_by_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE booking ADD CONSTRAINT FK_E00CEDDE43EE6C4C FOREIGN KEY (created_by_client_id) REFERENCES client (id)');
        $this->addSql('ALTER TABLE booking ADD CONSTRAINT FK_E00CEDDEBCEDEAAC FOREIGN KEY (updated_by_client_id) REFERENCES client (id)');
        $this->addSql('ALTER TABLE booking ADD CONSTRAINT FK_E00CEDDE7D182D95 FOREIGN KEY (created_by_user_id) REFERENCES client (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking DROP FOREIGN KEY FK_E00CEDDE43EE6C4C');
        $this->addSql('ALTER TABLE booking DROP FOREIGN KEY FK_E00CEDDEBCEDEAAC');
        $this->addSql('ALTER TABLE booking DROP FOREIGN KEY FK_E00CEDDE7D182D95');
